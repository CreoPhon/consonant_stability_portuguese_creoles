...
Supplementary materials for, "Consonant Stability in Portuguese-based creoles". In this report, we provide code in R [@R] and we use these R libraries [@tidyverse;@knitr;@ggrepel]:
